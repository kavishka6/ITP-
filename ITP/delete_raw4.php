        ...
        <center> 
            ...
            <div class="col-md-6">
                <div class="box box-default">
                    <form action = "delete_raw4.php" class="form-horizontal" method="POST"  enctype="multipart/form-data" name="form" id="form">
                        ...
                        <div class="box-body">
                            <div class="callout callout-danger">
                                ...
                                <div class="card-footer">
                                    <a href='row_category04.php?'><button type="button" class="btn btn-info float-left" >Cancel</button></a>
