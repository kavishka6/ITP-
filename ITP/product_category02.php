        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Add Product Category 02</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Product_category_02</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Enter the category Brand</h3>
                        </div>
                                ...
                                <thead>
                                 ...
                                 <tbody>';
                                    ...
                                    while ($arraySomething1 = mysqli_fetch_array($result)) {
                                        ...
                                        $brand1 = $arraySomething1['brand'];




                                        echo "<tr><td>&nbsp " . $brand1 . "</td>";

                                        echo"<td> <div class='btn-group'>
                              
                           <center>   <a href='delete_product_cat2.php?r=$id' button type='button' class='btn btn-warning'>Delete</button></center></div></td></tr>";
                                    }
