...
<html>
    <head>
        ...
        <link rel="stylesheet" href="plugins/datatables-responsive/css/responsive.bootstrap4.min.css">  <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Shanaz</title>
        <!-- Tell the browser to be responsive to screen width -->
        <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <div class="container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="examplesname">Category Model</label>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                         ...
                         <center>   <a href='delete_raw3.php?r=$id' button type='button' class='btn btn-warning'>Delete</button></div></td></center></tr>";
                                    }
